...
namespace VoxReader
{
    internal class FormatParser
    {
        ...
        public VectorData3 ParseVector3()
        {
            int x = ParseInt32();
            int y = ParseInt32();
            int z = ParseInt32();

            return new VectorData3(x, y, z);
        }
        ...
        public RawVoxel ParseRawVoxel()
        {
            ...
            var position = new VectorData3(x, y, z);
        ...
        public VoxColor ParseColor()
        {
            ...
            return new VoxColor(r, g, b, a);
        }

        public VoxColor[] ParseColors(int count)
        {
            var colors = new VoxColor[count];
